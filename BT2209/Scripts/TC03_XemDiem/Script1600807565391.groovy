...
WebUI.click(findTestObject('Object Repository/Page_UP Portal  HoChiMinh University of Pedagogy/a_Xem im'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_UP Portal  HoChiMinh University of Pedagogy/td_XEM IM'), 
    0)
